		...
		<div class="col-md-6 col-lg-5 center-sm">
  		...
  		<div class="col-md-6 col-lg-4">
  			<ul class="contacts">
  				...
  				<li><a href="https://www.youtube.com/channel/UCI-cdIEY91ideXWs8_ANK6Q"><i class="fa fa-youtube-play" aria-hidden="true"></i> Youtube channel</a></li>
  		...
  		<div class="col-md-12 col-lg-3 center-sm">
  			<h4>Blog Demo</h4>
  			<p>This is demo for blog layout for &lt;/&gt;DevStudy.net course. More information is here: <a href="http://devstudy.net/course/web-ishop" class="link" target="_blank">devstudy.net</a></p>
  			<div class="social">
