package com.revenat.iblog.presentation.infra.util;
...
import com.revenat.iblog.presentation.infra.config.Constants.Directory;
...
public final class RoutingUtils {
	...
	public static void forwardToPage(String jspPage, HttpServletRequest req, HttpServletResponse resp)
			throws ServletException, IOException {
		req.setAttribute(Attribute.CURRENT_PAGE, Directory.PAGE + jspPage);
